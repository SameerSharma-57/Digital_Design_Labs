...
##LED(GREEN)## 
set_property -dict { PACKAGE_PIN B20   IOSTANDARD LVCMOS33 } [get_ports { out[3] }]; #rpio_12
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 } [get_ports { out[2] }]; #rpio_13
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { out[1] }]; #rpio_22
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { out[0] }]; #rpio_23
